...
def setup_argparse():
    ...
    args.add_argument('--instance_id', type=str, default='your_instance_id', help='Sentinel Hub instance ID')
    args.add_argument('--client_id', type=str, default='your_client_id', help='Sentinel Hub client ID')
    args.add_argument('--client_secret', type=str, default='your_client_secret', help='Sentinel Hub client secret')
    args.add_argument('--bbox', type=str, default='13.4,52.5,13.6,52.7', help='Bounding box in the format minx,miny,maxx,maxy')
    args.add_argument('--time', type=str, default='2021-05/2021-08', help='Time range of the image in the format YYYY-MM/YYYY-MM')
    args.add_argument('--maxcc', type=int, default=20, help='Maximum cloud cover percentage')
    args.add_argument('--threshold', type=float, default=0.5, help='Threshold for inference')
    ...
    print(f'Command line arguments parsed successfully: {BBOX}, {TIME}, {MAX_CC}, {THRESHOLD}')
